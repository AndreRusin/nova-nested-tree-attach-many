...
use AndrewRus\NovaNestedTreeAttachMany\Rules\ArrayRules;
...
class NestedTreeAttachMany extends Field
{
    ...
    public function searchable(bool $searchable): NestedTreeAttachMany
    {
        $this->withMeta([
    ...
    public function withIdKey(string $idKey = 'id'): NestedTreeAttachMany
    {
        $this->withMeta([
            'idKey' => $idKey,
        ]);
    ...
    public function withLabelKey(string $labelKey = 'name'): NestedTreeAttachMany
    {
        $this->withMeta([
            'labelKey' => $labelKey,
        ]);
    ...
    public function withChildrenKey(string $childrenKey): NestedTreeAttachMany
    {
        $this->withMeta([
    ...
    public function withActiveKey(string $activeKey): NestedTreeAttachMany
    {
        $this->withMeta([
            'activeKey' => $activeKey,
        ]);
    ...
    public function withPlaceholder(string $placeholder): NestedTreeAttachMany
    {
        $this->withMeta([
    ...
    public function withMaxHeight(int $maxHeight): NestedTreeAttachMany
    {
        $this->withMeta([
            'maxHeight' => $maxHeight,
        ]);
    ...
    public function withAlwaysOpen(bool $alwaysOpen): NestedTreeAttachMany
    {
        $this->withMeta([
    ...
    public function withSortValueBy(string $sortBy): NestedTreeAttachMany
    {
        $this->withMeta([
            'sortValueBy' => $sortBy,
        ]);
    ...
    public function withFlatten(bool $flatten): NestedTreeAttachMany
    {
        $this->withMeta([
            'flatten' => $flatten,
        ]);
    ...
    public function isActiveFalseValue( $value = false ): NestedTreeAttachMany
    {
        $this->withMeta([
            'isActiveFalse' => $value,
        ]);
    ...
    public function useSingleSelect(): NestedTreeAttachMany
    {
        $this->withMeta([
            'multiple' => false,
            'flatten' => false
    ...
    public function useAsField(): NestedTreeAttachMany
    {
        $this->withMeta([
            'useAsField' => true,
        ]);
    ...
    public function disableBranchNodes(bool $disable = false): NestedTreeAttachMany
    {
        $this->withMeta([
            'disableBranchNodes' => $disable,
        ]);
